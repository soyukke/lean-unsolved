...
| 14 | {1,...,6} の sumset/prodset | — | sumset card=11=2·6-1, prodset card=18 をdecideで検証 |
| 15 | シングルトンの sumset/prodset | — | sumsetFinset {1} card=1, prodset {1,...,6} card=18 |
| 16 | 等比数列の prodset | — | {1,2,4,8}: prodset card=7 をdecideで検証 |
